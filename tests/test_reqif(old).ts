...
DataMap[Identifiable.name] = (v: any): unknown => {
    return {
        desc: v["@_DESC"],
...
DataMap[DatatypeDefinitionString.name] = (v: any): unknown => {
    return {
        maxLength: v["@_MAX-LENGTH"]
    };
}

DataMap[DatatypeDefinitionInteger.name] = (v: any): unknown => {
    return {
        // maxLength: v["@_MAX-LENGTH"]
    }
}

DataMap[DatatypeDefinitionEnumeration.name] = (v: any): unknown => {
    return {
        // maxLength: v["@_MAX-LENGTH"]
    }
}
...
//Spec Types
DataMap[SpecObjectType.name] = (v: any): unknown => {
    return {
        specAttributes: v["SPEC-ATTRIBUTES"]
    }
}

DataMap[SpecificationType.name] = (v: any): unknown => {
    return {
        specAttributes: v["SPEC-ATTRIBUTES"]
    }
}
...
//Spec objects
DataMap[SpecObject.name] = (v: any): unknown => {
    return {
        values: v["VALUES"],
        type: v["TYPE"]
    }
...
console.log(DatatypeDefinition.name);
